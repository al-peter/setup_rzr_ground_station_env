...
TEST(ardupilotmega, rzrc)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::rzrc packet_in{};
    packet_in.rX = 5;
    packet_in.rY = 72;
    packet_in.lY = -117;
    packet_in.lX = -50;
    ...
    mavlink::ardupilotmega::msg::rzrc packet1{};
    mavlink::ardupilotmega::msg::rzrc packet2{};
    ...
    EXPECT_EQ(packet1.rX, packet2.rX);
    EXPECT_EQ(packet1.rY, packet2.rY);
    EXPECT_EQ(packet1.lY, packet2.lY);
    EXPECT_EQ(packet1.lX, packet2.lX);
    EXPECT_EQ(packet1.tumbl, packet2.tumbl);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, rzrc)
{
    mavlink_message_t msg;
    ...
    mavlink_msg_rzrc_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.rX, packet2.rX);
    EXPECT_EQ(packet_in.rY, packet2.rY);
    EXPECT_EQ(packet_in.lY, packet2.lY);
    EXPECT_EQ(packet_in.lX, packet2.lX);
    EXPECT_EQ(packet_in.tumbl, packet2.tumbl);
...
TEST(ardupilotmega, RZR_LINK)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::RZR_LINK packet_in{};
    packet_in.value1 = 17;
    packet_in.value2 = 84;
    packet_in.value3 = 17235;
    packet_in.value4 = 17339;
    packet_in.value5 = -105;
    packet_in.value6 = -38;
    packet_in.value7 = 29;
    packet_in.value8 = 96;

    mavlink::ardupilotmega::msg::RZR_LINK packet1{};
    mavlink::ardupilotmega::msg::RZR_LINK packet2{};
...
#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, RZR_LINK)
{
    mavlink_message_t msg;
    ...
    mavlink_rzr_link_t packet_c {
         17235, 17339, 17, 84, -105, -38, 29, 96
    };
    ...
    mavlink_msg_rzr_link_encode(1, 1, &msg, &packet_c);
